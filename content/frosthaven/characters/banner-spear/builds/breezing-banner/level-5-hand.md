...
We’re also going to replace [At All Costs](#at-all-costs) here. With the falcon, it’s likely just too crowded to justify two summons each cycle. We don’t have anything we love to fill in the missing slot \- I’d bring [Incendiary Throw](#incendiary-throw) most of the time, but if there are heavy shielded enemies, consider [Tip of the Spear](#tip-of-the-spear) instead. And we’re always still considering [Pincer Movement](#pincer-movement) for very easy scenarios to get in a bit of bonus looting.
